...
const waGeneral = WA + encodeURIComponent('Hola, me interesa una membresía de AR Studio. ¿Me contáis los siguientes pasos?')
const waStarter = WA + encodeURIComponent('Hola, me interesa la membresía STARTER de AR Studio. ¿Me contáis los siguientes pasos?')
const waCreator = WA + encodeURIComponent('Hola, me interesa la membresía CREATOR de AR Studio. ¿Me contáis los siguientes pasos para reservar mi plaza?')
const waPro = WA + encodeURIComponent('Hola, me interesa la membresía PRO de AR Studio. ¿Me contáis los siguientes pasos?')
const mailto = 'mailto:arstudiospain@gmail.com?subject=' + encodeURIComponent('Membresía AR Studio') + '&body=' + encodeURIComponent('Hola, me interesa la membresía (Starter / Creator / Pro) de AR Studio. ¿Me contáis los siguientes pasos?')
  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:title" content="Plan mensual | Membresías de AR Studio" />
      ...
      <main className="membresias__master">

        {/* HERO */}
        <section className="membresias__hero">
          <span className="membresias__badge">Solo 10 plazas disponibles</span>
          <h1>El primer estudio de Valencia con acceso mensual para creadores y fotógrafos.</h1>
          <div className="membresias__hero_text">
          ...
          <div className="membresias__ctas">
            <ButtonArrow texto="VER MEMBRESÍAS" href="#planes" />
            <ButtonArrow texto="ESCRÍBENOS" href={waGeneral} />
          </div>
        </section>

        <div className="membresias__strip">
        ...
        {/* INTRO */}
        <section className="membresias__intro">
          <h2>Un espacio pensado para lo que no se improvisa.</h2>
          <div className="membresias__intro_text">
            <p>AR Studio Valencia abre <strong>por primera vez</strong> un número limitado de membresías mensuales, pensadas para quien produce con constancia: contenido de marca personal, fotografía con clientes, podcast y producción de producto.</p>
            <ul className="membresias__lista">
        ...
        {/* ESPACIO */}
        <section className="membresias__espacio" id="espacio">
          <Image className="membresias__portada" src="/media/col2.jpg" alt="Interior y mobiliario de AR Studio en Valencia" loading="lazy" decoding="async" width={600} height={600} />
          <div className="membresias__espacio_content">
            <span className="membresias__label">El espacio</span>
            ...
            <dl className="membresias__stats">
        ...
        {/* MATERIAL */}
        <section className="membresias__material">
          <span className="membresias__label">Incluido en todas las membresías</span>
          <h2>Todo el material,<br />sin coste adicional.</h2>
          <p className="membresias__lead">Esto es lo que hace diferente a AR Studio. <strong>No alquilas solo un espacio:</strong> tienes acceso a todo el equipo profesional, sin coste adicional, en todas las membresías.</p>

          <div className="membresias__material_grid">
            <div>
              <h3>Iluminación</h3>
              <ul>
                <li>GODOX MS300 (×2)</li>
          ...
          <p className="membresias__nota">*Fondos de color: único coste extra, 20€ + IVA por metro pisado.</p>
        </section>

        {/* PLANES */}
        <section className="membresias__planes" id="planes">
          <div className="membresias__planes_head">
            <span className="membresias__label">Membresías 2026</span>
          ...
          <div className="membresias__cards">

            <div className="membresias__card">
              <h3>Starter</h3>
              <p className="membresias__card_for">Para el creador que empieza a producir con constancia.</p>
              <p className="membresias__price">149€<small>/mes</small></p>
              <p className="membresias__hora">8 horas al mes · sale a 18,6€/hora</p>
              <ul>
              ...
              <p className="membresias__ahorro">A tarifa normal: 392€/mes. <strong>Ahorras 243€ cada mes.</strong></p>
              <ButtonArrow texto="QUIERO STARTER" href={waStarter} />
              <p className="membresias__plazas">6 plazas</p>
            </div>

            <div className="membresias__card membresias__card--destacada">
              <span className="membresias__ribbon">El más elegido</span>
              <h3>Creator</h3>
              <p className="membresias__card_for">Para el creador o fotógrafo que trabaja el estudio como parte de su negocio.</p>
              <p className="membresias__price">249€<small>/mes</small></p>
              <p className="membresias__hora">16 horas al mes · sale a 15,6€/hora</p>
              <ul>
              ...
              <p className="membresias__ahorro">A tarifa normal: 784€/mes. <strong>Ahorras 535€ cada mes.</strong></p>
              <ButtonArrow texto="QUIERO CREATOR" href={waCreator} />
              <p className="membresias__plazas">3 plazas</p>
            </div>

            <div className="membresias__card">
              <h3>Pro</h3>
              <p className="membresias__card_for">Para el fotógrafo profesional que trabaja con clientes y necesita máxima flexibilidad.</p>
              <p className="membresias__price">499€<small>/mes</small></p>
              <p className="membresias__hora">36 horas al mes · sale a 13,9€/hora</p>
              <ul>
              ...
              <p className="membresias__ahorro">A tarifa normal: más de 1.760€/mes. <strong>Ahorras más de 1.250€.</strong></p>
              <ButtonArrow texto="QUIERO PRO" href={waPro} />
              <p className="membresias__plazas">1 plaza</p>
            </div>

          </div>

          <div className="membresias__fundador">
            <h3>Precio fundador</h3>
            <p>Los primeros miembros <strong>congelan su precio indefinidamente</strong> mientras mantengan la membresía activa. Si los precios suben, tú mantienes el tuyo. Esta condición solo existe en esta primera apertura.</p>
          </div>
        </section>

        {/* COMPARATIVA */}
        <section className="membresias__compara">
          <span className="membresias__label">Comparativa</span>
          <h2>Los tres planes,<br />frente a frente</h2>
          <div className="membresias__tabla_scroll">
            <table className="membresias__tabla">
              <thead>
                <tr>
                  <th></th>
                  <th>Starter</th>
        ...
        {/* CONDICIONES */}
        <section className="membresias__condiciones">
          <span className="membresias__label">Claro y por escrito</span>
          <h2>Condiciones<br />de la membresía</h2>
          <div className="membresias__cond_grid">
            <div>
              <h3>Compromiso y pago</h3>
              <ul>
                <li>Permanencia mínima de 3 meses.</li>
                <li>Pago mensual. Sin pagos por adelantado de varios meses.</li>
                <li>Precio fundador: tu cuota queda congelada mientras mantengas la membresía activa.</li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul>
                <li>Membresía personal e intransferible. Puedes traer clientes o modelos a tus sesiones.</li>
                <li>Solo un miembro usa el estudio a la vez: tu sesión es tuya.</li>
            ...
            <div className="membresias__cond_wide">
              ...
              <div className="membresias__excepciones">
                <div>
                  <h4>Creator</h4>
          ...
          <p className="membresias__nota">La franja de mañana (9–14h) es exclusiva del plan Pro. Sábados disponibles a tarifa normal (mínimo 4h), salvo el sábado mensual del plan Pro. Domingos no incluidos.</p>
        </section>

        {/* CONTACTO */}
        <section className="membresias__contacto" id="unirte">
          <span className="membresias__badge">Solo 10 plazas en esta primera apertura</span>
          <h2>Da el paso</h2>
          <div className="membresias__contacto_text">
            <p>Las membresías se abren por primera vez y con plazas muy limitadas para garantizar que cada miembro tenga <strong>disponibilidad real</strong> del estudio. Cuando se completen las 10 plazas, abrimos lista de espera.</p>
          ...
          <div className="membresias__canales">
            <a className="membresias__canal membresias__canal--destacado" href={waGeneral} target="_blank" rel="noopener noreferrer">
              <h3>WhatsApp</h3>
              <span>+34 613 39 55 33</span>
            </a>
            <a className="membresias__canal" href={mailto}>
              <h3>Correo</h3>
              <span>arstudiospain@gmail.com</span>
            </a>
            <a className="membresias__canal" href="https://www.instagram.com/studioar.es/" target="_blank" rel="noopener noreferrer">
              <h3>Instagram</h3>
      ...
      <a className="membresias__sticky" href={waGeneral} target="_blank" rel="noopener noreferrer">Reservar mi plaza</a>
    </>
  )
}
